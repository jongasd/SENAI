...
//     }
//     resumoCusto(){
//         return `O projeto ${this.nomeProjeto}, tem um orcamento base de: ${this.orcamentoBase}, para ${this.diasPlanejados} dias, com o custo diário de: ${this.calcularCustoDiario()}`
